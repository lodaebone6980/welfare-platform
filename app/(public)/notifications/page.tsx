    ...
    <div className="pb-24 px-4 pt-8">
      ...
      <div className="mt-8 space-y-3">
        <div className="bg-white rounded-xl border border-gray-100 p-4 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-gray-800">지원금길잡이 서비스 안내</p>
            <p className="text-xs text-gray-500 mt-0.5">지원금길잡이는 정부 및 지자체의 다양한 복지 정책, 지원금, 보조금 정보를 한곳에서 확인할 수 있는 서비스입니다.</p>
