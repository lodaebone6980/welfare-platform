...
const DEFAULT_CONTENT = `블루엣지(이하 "회사")는 지원금길잡이(www.govmate.co.kr, 이하 "서비스")를 운영하면서 이용자의 개인정보를 소중히 여기며, 「개인정보 보호법」 등 관련 법령을 준수합니다.
...
export const metadata: Metadata = {
  title: '개인정보처리방침 | 지원금길잡이',
  description:
    '지원금길잡이의 개인정보 수집·이용·보관 및 이용자의 권리에 대한 안내입니다.',
