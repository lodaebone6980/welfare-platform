    ...
    <div className="p-6 max-w-6xl">
      ...
      <div className="grid grid-cols-4 gap-3 mb-5">
        {[
          ...
          <div key={m.label} className="bg-white border border-gray-100 rounded-xl p-4">
            ...
            <div className="text-xl font-medium text-gray-800">{m.value}</div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white border border-gray-100 rounded-xl p-4">
          <div className="text-xs font-medium text-gray-600 mb-3">최근 발행 정책</div>
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-4">
          ...
          <div className="space-y-2">
            {stats.map((s, i) => (
              <div key={s.format} className="flex items-center gap-3">
                <span className="w-16 text-xs text-gray-500 flex-shrink-0">{s.format}</span>
                ...
                <span className={`text-xs w-8 text-right ${s.rewardRate >= 50 ? 'text-green-600' : 'text-red-500'}`}>
                  {s.rewardRate}%
                </span>
              </div>
            ))}
